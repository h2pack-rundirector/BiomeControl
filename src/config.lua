return {
    ...
    ViewRegion = 1,
    PackedBiomeControlMode1 = 0,
    PackedBiomeControlMode2 = 0,
    PackedBiomeControlMode3 = 0,
    PackedBiomeControlMode4 = 0,
    PackedBiomeControlNPCMode1 = 0,
    PackedBiomeControlNPCMode2 = 0,
    PackedBiomeControlNPCMode3 = 0,
    PackedBiomeControlNPCMode4 = 0,
